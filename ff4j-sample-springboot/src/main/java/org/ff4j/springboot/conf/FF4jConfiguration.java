...
public class FF4jConfiguration {
    ...
    public static final String SPECIFIC_PROJECTS_FEATURE = "specificProjectsFeature";
    public static final String ALL_PROJECTS_FEATURE = "allProjectsFeature";
    ...
    public FF4j getFF4j() {
        ...
        Feature spf = new Feature(SPECIFIC_PROJECTS_FEATURE);
        spf.setFlippingStrategy(new ProjectFlipStrategy("100344,12786"));
        ff4j.createFeature(spf);

        Feature allpf = new Feature(ALL_PROJECTS_FEATURE);
        allpf.setFlippingStrategy(new ProjectFlipStrategy(ProjectFlipStrategy.ALL_PROJECTS));
        ff4j.createFeature(allpf);
